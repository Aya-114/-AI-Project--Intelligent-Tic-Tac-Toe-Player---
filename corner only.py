...
class TicTacToe:
    ...
    def ai_move_corner_heuristic(self):
        ...
        if available_corners:
            best_move = available_corners[0]  # خذ أول زاوية متاحة
        else:
            # لو مافيش زاوية متاحة اختار أول مكان فاضي
            best_move = None
            for i in range(3):
                for j in range(3):
                    if self.board[i][j] == '-':
